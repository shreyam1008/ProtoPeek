...
In v0.6.1, an eligible TCP listener whose evidence is no more than five
...
The Windows backend has real-host and synthetic acceptance recorded in the v0.6.1 overhaul guide. macOS activity,
