...
The v0.4.0 release promotes the Network Workbench: native Linux path evidence, authorized private
...
their corresponding workflows completed. WinGet and community launch submissions remain gated on
initial user feedback rather than being presented as shipped.
