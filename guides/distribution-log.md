...
| --- | --- | --- | --- |
| Product website | v0.3.0 docs | **Live** | Custom domain serves the prerendered v0.3.0 site over HTTPS and the legacy Pages URL redirects each path to it. |
| GitHub Releases | v0.3.0 | **Live stable** | The public latest release has eight platform archives, eight matching SBOMs, checksums, both installers, and provenance for the archive/SBOM subjects. |
...
v0.3.0 is the current stable release of the protocol workbench. Its website,
installers, archives, checksums, SBOMs, attestations, owned Homebrew/Scoop
definitions, and three-OS CI describe the same version.
