...
func buildBootstrap(target string, methods []*desc.MethodDescriptor, opts *handlerOptions) ([]byte, error) {
	...
	return json.Marshal(bootstrapResponse{
		...
		DocsURL:         "https://shreyam1008.github.io/ProtoPeek/docs/",
		...
		TargetDefaults: bootstrapTargetDefaults{
			...
			ProtoFiles:   append([]string(nil), opts.targetDefaults.ProtoFiles...),
			ImportPaths:  append([]string(nil), opts.targetDefaults.ImportPaths...),
			Protosets:    append([]string(nil), opts.targetDefaults.Protosets...),
		},
