...
//
// This is the same web content that the `protopeek` command-line program
// exposes. It starts up a web server that includes only this stand-alone
// handler. If you need more control over the page in which the UI form gets
// embedded or over the CSS/styling of the page, instead use the various
// functions in the root ProtoPeek module to assemble your own web UI.
//
